...
export const MOODS: MoodDef[] = [
  {
    ...
    intensity: 1,
    color: N.moodCalm,
    dimColor: N.moodCalmDim,
    borderSel: N.moodCalmBorder,
  },
  {
    key: "tense",
    label: "Tense",
    intensity: 2,
    color: N.moodTense,
    dimColor: N.moodTenseDim,
    borderSel: N.moodTenseBorder,
  },
  {
    key: "anxious",
    label: "Anxious",
    intensity: 3,
    color: N.moodAnxious,
    dimColor: N.moodAnxiousDim,
    borderSel: N.moodAnxiousBorder,
  },
  {
    key: "exhausted",
    label: "Exhausted",
    intensity: 4,
    color: N.moodExhausted,
    dimColor: N.moodExhaustedDim,
    borderSel: N.moodExhaustedBorder,
  },
  {
    key: "overwhelmed",
    label: "Overwhelmed",
    intensity: 5,
    color: N.moodOverwhelmed,
    dimColor: N.moodOverwhelmedDim,
    borderSel: N.moodOverwhelmedBorder,
  },
];
